...
export interface IpcChannels {
  ...
  'dialog:openFile': { args: [options?: unknown]; result: { canceled: boolean; filePaths: string[] } };
  'dialog:openFolder': { args: []; result: string[] };
  'dialog:openFolderFiles': { args: []; result: { canceled: boolean; filePaths: string[] } };
  'dialog:saveFile': { args: [options?: unknown]; result: { canceled: boolean; filePaths: string[] } };
  ...
  'library:scan': { args: [folderPaths: string[]]; result: { count: number; folderTypes: Record<string, 'audio' | 'video' | 'mixed'> } };
  'library:loadFolders': { args: []; result: string[] };
  'library:saveFolders': { args: [folders: string[]]; result: string[] };
  'library:loadScanned': { args: []; result: { files: IpcMediaFile[]; folderTypes: Record<string, 'audio' | 'video' | 'mixed'> } | null };
  'library:saveScanned': { args: [data: { files: IpcMediaFile[]; folderTypes: Record<string, 'audio' | 'video' | 'mixed'> }]; result: void };
  ...
  'media:getCover': { args: [filePath: string]; result: { type: 'video' | 'image' | null; data: string | null } };
  'media:getDuration': { args: [filePath: string]; result: number };
  'media:writeTags': { args: [filePath: string, tags: Record<string, string | undefined>]; result: { success: boolean; error?: string } };
  'media:renameFile': { args: [oldPath: string, newName: string]; result: { success: boolean; error?: string; newPath?: string } };
  'media:writeCover': { args: [filePath: string, imageSource: number[] | string]; result: { success: boolean; error?: string } };
  'media:readCover': { args: [filePath: string]; result: { mime?: string; data?: number[] } | null };
  ...
  'dep:checkYtdlp': { args: []; result: { installed: boolean; version: string | null; path: string | null } };
  ...
  'musicbrainz:searchRelease': { args: [query: string]; result: { success: boolean; releases: unknown[]; error?: string } };
  'musicbrainz:lookupRelease': { args: [releaseId: string]; result: { success: boolean; release?: unknown; error?: string } };
  'musicbrainz:getCoverData': { args: [releaseId: string]; result: { success: boolean; data?: number[]; mime?: string; error?: string } };
}
