...
import { Palette, Play, Download, Keyboard, Globe, Key, RefreshCw, Box, PictureInPicture, RotateCcw } from '@lucide/vue';
    ...
    <div class="w-56 border-r border-border-default p-3 shrink-0">
      ...
      <div class="space-y-0.5">
        <button v-for="t in tabs" :key="t.id"
          ...
          :class="tab === t.id ? 'bg-accent-ghost text-accent-base' : 'text-fg-muted hover:bg-bg-hover hover:text-fg-base'"
          @click="tab = t.id">
