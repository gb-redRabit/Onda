...
interface OndaAPI {
  ...
  pipStart: (videoSrc: string, settings?: {
    position?: string; width?: number; height?: number; startTime?: number;
    subtitle?: { subContent: string; fonts: Array<{ name: string; data: number[] }>; availableFonts: Record<string, string> } | null;
  }) => Promise<boolean>;
  pipStop: () => Promise<boolean>;
  pipPreviewStart: (opts: { position?: string; width?: number; height?: number }) => Promise<boolean>;
  pipPreviewStop: () => Promise<boolean>;
  pipPreviewUpdate: (opts: { position?: string; width?: number; height?: number }) => Promise<boolean>;
  pipPreload: (videoSrc: string, subtitleData: { subContent: string; fonts: Array<{ name: string; data: number[] }>; availableFonts: Record<string, string> } | null) => Promise<void>;
  pipLoadTrack: (videoSrc: string, subtitleData: { subContent: string; fonts: Array<{ name: string; data: number[] }>; availableFonts: Record<string, string> } | null) => Promise<void>;
  pipUpdateSubtitle: (data: { subContent: string; fonts: Array<{ name: string; data: number[] }>; availableFonts: Record<string, string> } | null) => Promise<void>;
  ...
  writeTags: (filePath: string, tags: Record<string, string | undefined>) => Promise<{ success: boolean; error?: string }>;
  ...
  listEmbeddedSubtitles: (filePath: string) => Promise<Array<{ index: number; language: string; title: string; codec: string }>>;
  extractEmbeddedSubtitle: (filePath: string, streamIndex: number) => Promise<{ content: string; format: string } | null>;
  findExternalSubtitles: (videoPath: string) => Promise<Array<{ name: string; path: string; format: string }>>;
