export default {
  ...
  saved: {
    ...
    radioTitle: 'Radio',
    emptyTracks: 'Brak zapisanych utworów — zapisz utwór ikoną zapisu przy „Odtwórz" w widoku YouTube.',
    emptyPlaylists: 'Brak zapisanych playlist — zapisz playlistę przyciskiem zapisu obok „Otwórz wszystko".',
  ...
  radio: {
    ...
    fileHint: 'Obsługiwane: .pls (SHOUTcast/Icecast), .m3u/.m3u8, .xspf oraz pliki z bezpośrednimi adresami strumieni.',
