export default {
  ...
  settings: {
    ...
    updateToastAvailableTitle: 'Update available',
    updateToastAvailableMessage: 'Version {version} is ready — download it in Settings → Updates.',
    updateToastReadyTitle: 'Update ready',
    updateToastReadyMessage: 'Version {version} will install after restart — Settings → Updates.',
    general: 'General',
    ...
    resolverTitle: 'Dependency resolver',
    resolverDesc: 'How Onda resolved FFmpeg/yt-dlp on this machine. Local report only.',
    resolverEmpty: 'No tools resolved yet.',
    ...
    cacheDesc:
      'Covers, thumbnails, stream URLs and remote images. Cleared data rebuilds automatically.',
    cacheClear: 'Clear cache',
    cacheCleared: 'Cache cleared',
    cacheClearedDetail: 'Removed {files} file(s), {size} freed.',
    cacheClearError: 'Failed to clear cache',
    resetFactoryTitle: 'Factory reset',
    resetFactoryDesc:
      'Removes all app data: settings, library, downloads, accounts, plugins and caches. Your media files stay untouched.',
    resetFactoryButton: 'Restore factory settings',
    resetFactoryConfirm:
  ...
  "permissions": {
    "network": { "allow": ["https://httpbin.org/*"] }
        ...
        },
        {
          ...
          body: 'Requires the visual permission. Applies decorations to audio view elements (key element.decoration). Decorations come only from plugins - the app ships no built-in shapes or styles:',
          list: [
            'Allowed elements: cover, visualization, progress, trackInfo, controls',
            'The value is either "none" (clears the decoration) or "plugin:<element>:<variant>" - the variant must be declared in this plugin manifest (layoutElements) and implemented by the host',
            'The host currently implements cover variants: triangle, circle, diamond, hexagon, flip-x',
            'Example: api.visual("element.decoration", { element: "cover", value: "plugin:cover:triangle" }) - the cover is clipped to a triangle',
            ...
            'Decorations set by a plugin apply globally in the audio view; the layout editor choice (Variant tab → Decoration) is used when no plugin overrides it'
          ]
        },
        {
...
api.registerCommand({
  ...
  audioView: {
    ...
    decorationNone: 'None',
    decorationHint:
      'Decorations come only from plugins — options appear when an active plugin declares a variant for this element.',
