export default {
  ...
  saved: {
    ...
    radioTitle: 'Radio',
    emptyTracks: 'No saved tracks yet — save a track with the bookmark icon next to "Play" in the YouTube view.',
    emptyPlaylists: 'No saved playlists yet — save a playlist with the bookmark button next to "Play all".',
  ...
  radio: {
    ...
    fileHint: 'Supported: .pls (SHOUTcast/Icecast), .m3u/.m3u8, .xspf and files with direct stream URLs.',
