...
export const DEFAULT_APPEARANCE = {
  ...
  audioLayout: {
    elements: [
      ...
      { id: 'cover' as const, x: 27, y: 8, width: 46, height: 50, opacity: 100, layer: 2, visible: true },
      { id: 'trackInfo' as const, x: 18, y: 61, width: 64, height: 12, opacity: 100, layer: 3, visible: true },
      { id: 'progress' as const, x: 15, y: 75, width: 70, height: 5, opacity: 100, layer: 3, visible: true },
      { id: 'controls' as const, x: 15, y: 82, width: 70, height: 14, opacity: 100, layer: 5, visible: true }
    ],
...
export const AUDIO_LAYOUT_PRESETS: Record<string, { label: string; elements: typeof DEFAULT_APPEARANCE.audioLayout.elements }> = {
  compact: {
    ...
    elements: [
      ...
      { id: 'trackInfo', x: 30, y: 26, width: 66, height: 13, opacity: 100, layer: 3, visible: true },
  ...
  stacked: {
    ...
    elements: [
      ...
      { id: 'trackInfo', x: 22, y: 47, width: 56, height: 12, opacity: 100, layer: 3, visible: true },
  ...
  split: {
    ...
    elements: [
      ...
      { id: 'trackInfo', x: 4, y: 62, width: 40, height: 10, opacity: 100, layer: 3, visible: true },
  ...
  full: {
    ...
    elements: [
      ...
      { id: 'trackInfo', x: 18, y: 61, width: 64, height: 12, opacity: 100, layer: 3, visible: true },
